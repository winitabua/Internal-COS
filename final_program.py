...
def func_rectangle():
    ...
    if calc_type == "1":
        print("Area of this rectangle is {:.2f}".format(rec_area))
    elif calc_type == "2":
        print("Perimeter of this rectangle is {:.2f}".format(rec_p))
    elif calc_type == "3":
        print("Area of this rectangle is {:.2f}\nPerimeter of this rectangle is {:.2f}"
...
def func_square():
    ...
    calc_type = get_calculation_type()
    if calc_type == "1":
        print("Area of this square is {:.2f}".format(square_area))
    elif calc_type == "2":
        print("Perimeter of this square is {:.2f}".format(square_p))
    elif calc_type == "3":
        print("Area of this square is {:.2f}\nPerimeter of this square is {:.2f}"
...
def func_triangle():
    ...
    print("Triangle height is {} and base is {} and sides are {} and {}"
          .format(tri_height, tri_base, tri_side_left, tri_side_right))
    ...
    calc_type = get_calculation_type()
    if calc_type == "1":
        print("Area of the triangle is {:.2f}".format(tri_area))
    elif calc_type == "2":
        print("Perimeter of this triangle is {:.2f}".format(tri_p))
    elif calc_type == "3":
        print("Area of this triangle is {:.2f}\nPerimeter of this triangle is {:.2f}"
...
def func_circle():
    ...
    calc_type = get_calculation_type()
    if calc_type == "1":
        print("Area of the circle is {:.2f}".format(cir_area))
    elif calc_type == "2":
        print("Perimeter of this circle is {:.2f}".format(cir_p))
    elif calc_type == "3":
        print("Area of this circle is {:.2f}\nPerimeter of this circle is {:.2f}"
...
def func_parallelogram():
    ...
    calc_type = get_calculation_type()
    if calc_type == "1":
        print("Area of the Parallelogram is {:.2f}".format(paralle_area))
    elif calc_type == "2":
        print("Perimeter of this Parallelogram is {:.2f}".format(paralle_p))
    elif calc_type == "3":
        print("Area of this Parallelogram is {:.2f}\nPerimeter of this Parallelogram is {:.2f}"
              .format(paralle_area, paralle_p))

    calculation_history_A.append((paralle_area))
    calculation_history_P.append((paralle_p))

# enter to continue in a function
def enter_continue():
    print()
...
print("\nHope you find this program helpful. Thank you for visiting this site :)")
